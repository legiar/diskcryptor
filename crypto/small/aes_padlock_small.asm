...
%define REP_XCRYPTECB db 0F3h, 0Fh, 0A7h, 0C8h
...
global _aes256_padlock_available
global _aes256_padlock_encrypt
global _aes256_padlock_decrypt

_aes256_padlock_available:
 push	 ebx
 ; test for VIA CPU
 mov	 eax, 0C0000000h
 cpuid
