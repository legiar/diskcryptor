...
%define etab_0(x)   [_Te0+4*x]
%define etab_1(x)   [_Te1+4*x]
%define etab_2(x)   [_Te2+4*x]
%define etab_3(x)   [_Te3+4*x]
...
%define eltab_0(x)  [_Te4_1+4*x]
%define eltab_1(x)  [_Te4_2+4*x]
%define eltab_2(x)  [_Te4_3+4*x]
%define eltab_3(x)  [_Te4_4+4*x]
...
%define dtab_0(x)   [_Td0+4*x]
%define dtab_1(x)   [_Td1+4*x]
%define dtab_2(x)   [_Td2+4*x]
%define dtab_3(x)   [_Td3+4*x]
...
%define dltab_0(x)  [_Td4_1+4*x]
%define dltab_1(x)  [_Td4_2+4*x]
%define dltab_2(x)  [_Td4_3+4*x]
%define dltab_3(x)  [_Td4_4+4*x]
